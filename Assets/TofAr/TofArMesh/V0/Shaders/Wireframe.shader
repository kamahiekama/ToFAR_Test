	...
	SubShader
	{
		...
		Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				float depth = ( i.vertex.z * 15000.f);
				float lineWidth = _LineWidth * depth;
				float lineWidthThreshold = 0.01;
                ...
                float alpha = 1.0 - smoothstep(1.0,1.0 + (lineWidthThreshold/lineWidth),distNorm);
