...
namespace TofAr.V0.Tof
{
    ...
    /// <para>下記機能を有する</para>
    /// <list type="bullet">
    /// <item><description>端末内共通キャリブレーション適用</description></item>
    /// <item><description>ユーザー定義キャリブレーション適用</description></item>
    /// </list>
    /// </summary>
    public class ReorientRelativeColorCamera : MonoBehaviour
    {
        /// <summary>
        /// <para>true: 端末の回転方向に応じてCameraを回転させる</para>
        /// <para>false: Cameraの自動回転を行わない</para>
        ...
        /// キャリブレーション適用
        /// </summary>
        /// <param name="settings">キャリブレーション設定データ</param>
